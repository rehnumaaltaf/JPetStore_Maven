 ...
 */
@Entity
@Table(name = "MASTER_GRADE_EXTERNAL_MAPPING")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MasterGradeExternalMapping.findAll", query = "SELECT m FROM MasterGradeExternalMapping m")})
public class MasterGradeExternalMapping implements Serializable {

    private static final long serialVersionUID = 1L;
    @SequenceGenerator(name="MASTER_GRADE_EXTERNAL_MAPPINGIDSEQ_GENERATOR", sequenceName="GRADE_EXTERNAL_MAPPING_ID_SEQ",allocationSize=1)
	@GeneratedValue(generator="MASTER_GRADE_EXTERNAL_MAPPINGIDSEQ_GENERATOR")
    @Id
    @Basic(optional = false)
    @NotNull
    @Column(name = "PK_GRADE_EXTERNAL_MAPPING_ID")
    private Integer pkGradeExternalMappingId;
    ...
    public MasterGradeExternalMapping() {
    }

    public MasterGradeExternalMapping(Integer pkGradeExternalMappingId) {
        this.pkGradeExternalMappingId = pkGradeExternalMappingId;
    }

    public Integer getPkGradeExternalMappingId() {
        return pkGradeExternalMappingId;
    }

    public void setPkGradeExternalMappingId(Integer pkGradeExternalMappingId) {
        this.pkGradeExternalMappingId = pkGradeExternalMappingId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (pkGradeExternalMappingId != null ? pkGradeExternalMappingId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MasterGradeExternalMapping)) {
            return false;
        }
        MasterGradeExternalMapping other = (MasterGradeExternalMapping) object;
        if ((this.pkGradeExternalMappingId == null && other.pkGradeExternalMappingId != null) || (this.pkGradeExternalMappingId != null && !this.pkGradeExternalMappingId.equals(other.pkGradeExternalMappingId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.olam.score.reference.domain.MasterGradeExternalMapping[ pkGradeExternalMappingId=" + pkGradeExternalMappingId + " ]";
    }
