 ...
 */
@Entity
@Table(name = "MASTER_PRODUCT_INTL_CODE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MasterProductIntlCode.findAll", query = "SELECT m FROM MasterProductIntlCode m")})
public class MasterProductIntlCode implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MASTER_PRODUCT_INTL_CODE_GENERATOR")
	@SequenceGenerator(name="MASTER_PRODUCT_INTL_CODE_GENERATOR", sequenceName="product.PRODUCT_CLASSIFICATION_REF_ID_SEQ",allocationSize=1)
    @NotNull
    @Column(name = "PK_PRODUCT_INTL_CODE_ID")
    private Integer pkProductIntlCodeId;
    @Size(max = 50)
    ...
    @Column(name = "FK_INTL_CODE_TYPE_REF_ID")
    private Integer fkIntlCodeTypeRefId;
    @JoinColumn(name = "FK_PROD_ID", referencedColumnName = "PK_PROD_ID")
    @ManyToOne
    private MasterProduct fkProdId;

    public MasterProductIntlCode() {
    }

    public MasterProductIntlCode(Integer pkProductIntlCodeId) {
        this.pkProductIntlCodeId = pkProductIntlCodeId;
    }

    public Integer getPkProductIntlCodeId() {
        return pkProductIntlCodeId;
    }

    public void setPkProductIntlCodeId(Integer pkProductIntlCodeId) {
        this.pkProductIntlCodeId = pkProductIntlCodeId;
    }
    ...
    public Integer getFkIntlCodeTypeRefId() {
		return fkIntlCodeTypeRefId;
	}

	public void setFkIntlCodeTypeRefId(Integer fkIntlCodeTypeRefId) {
		this.fkIntlCodeTypeRefId = fkIntlCodeTypeRefId;
	}
    ...
    public int hashCode() {
        int hash = 0;
        hash += (pkProductIntlCodeId != null ? pkProductIntlCodeId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MasterProductIntlCode)) {
            return false;
        }
        MasterProductIntlCode other = (MasterProductIntlCode) object;
        if ((this.pkProductIntlCodeId == null && other.pkProductIntlCodeId != null) || (this.pkProductIntlCodeId != null && !this.pkProductIntlCodeId.equals(other.pkProductIntlCodeId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.olam.score.product.domain.MasterProductIntlCode[ pkProductIntlCodeId=" + pkProductIntlCodeId + " ]";
    }
