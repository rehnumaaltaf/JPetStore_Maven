 ...
 */
@Entity
@Table(name = "MASTER_UNIT_LE")
@NamedQueries({
    @NamedQuery(name = "MasterUnitLe.findAll", query = "SELECT m FROM MasterUnitLe m")})
public class MasterUnitLe implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @NotNull
    @Column(name = "PK_UNIT_LE_ID")
    private Integer pkUnitLeId;
    @Size(max = 100)
    ...
    public MasterUnitLe(Integer pkUnitLeId) {
        this.pkUnitLeId = pkUnitLeId;
    }

    public Integer getPkUnitLeId() {
        return pkUnitLeId;
    }

    public void setPkUnitLeId(Integer pkUnitLeId) {
        this.pkUnitLeId = pkUnitLeId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (pkUnitLeId != null ? pkUnitLeId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MasterUnitLe)) {
            return false;
        }
        MasterUnitLe other = (MasterUnitLe) object;
        if ((this.pkUnitLeId == null && other.pkUnitLeId != null) || (this.pkUnitLeId != null && !this.pkUnitLeId.equals(other.pkUnitLeId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.olam.score.party.domain.MasterUnitLe[ pkUnitLeId=" + pkUnitLeId + " ]";
    }
