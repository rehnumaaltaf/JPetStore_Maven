 ...
 */
@Entity
@Table(name = "MASTER_UNIT_EXTERNAL_MAPPING")
@NamedQueries({
    @NamedQuery(name = "MasterUnitExternalMapping.findAll", query = "SELECT m FROM MasterUnitExternalMapping m")})
public class MasterUnitExternalMapping implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @NotNull
    @Column(name = "PK_UNIT_EXTERNAL_MAPPING_ID")
    private Integer pkUnitExternalMappingId;
    ...
    public MasterUnitExternalMapping() {
    }

    public MasterUnitExternalMapping(Integer pkUnitExternalMappingId) {
        this.pkUnitExternalMappingId = pkUnitExternalMappingId;
    }

    public Integer getPkUnitExternalMappingId() {
        return pkUnitExternalMappingId;
    }

    public void setPkUnitExternalMappingId(Integer pkUnitExternalMappingId) {
        this.pkUnitExternalMappingId = pkUnitExternalMappingId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (pkUnitExternalMappingId != null ? pkUnitExternalMappingId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MasterUnitExternalMapping)) {
            return false;
        }
        MasterUnitExternalMapping other = (MasterUnitExternalMapping) object;
        if ((this.pkUnitExternalMappingId == null && other.pkUnitExternalMappingId != null) || (this.pkUnitExternalMappingId != null && !this.pkUnitExternalMappingId.equals(other.pkUnitExternalMappingId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.olam.score.party.domain.MasterUnitExternalMapping[ pkUnitExternalMappingId=" + pkUnitExternalMappingId + " ]";
    }
