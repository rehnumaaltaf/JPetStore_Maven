...
export class EditService extends BehaviorSubject<any[]> {
    ...
    private fetch(action: string = "", data?: any): Observable<any[]>  {
        /*return this.jsonp
            ...
            .map(response => response.json());https://api.myjson.com/bins/bkivl*/
            return this.http.get('http://localhost:8082/cropyearservice/cropyear').map((response: Response) =>response.json());
