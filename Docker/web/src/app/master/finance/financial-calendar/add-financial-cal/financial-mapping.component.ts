...
@Component({
  moduleId: module.id,
  selector: 'app-financial-mapping',
  templateUrl: 'financial-mapping.component.html',
})
export class FinancialMappingComponent implements OnChanges {
  ...
  @Input('group')
  public tenorMappingForm: FormGroup;
  @Input() title: Number;
  @Input() ArrayIndex: number;
  @Input() AddEditId: number;
  @Input() financialCalendarModel: FinancialCalendar;

  constructor(public financialService: FinancialCalendarService) { }
  ngOnChanges(): void {
    console.log(this.AddEditId + '  From child component');
    if (this.AddEditId !== 0) {
      // tslint:disable-next-line:max-line-length
      if (this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex] !== undefined) {
        this.tenorMappingForm.controls['pkFinCalMappindId'].setValue(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex]
          .pkFinCalMappindId);
        this.tenorMappingForm.controls['productId'].setValue(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex].productId);
        this.tenorMappingForm.controls['monthShortCode'].setValue(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex]
          .monthShortCode);
        this.tenorMappingForm.controls['startDate'].setValue(new Date(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex]
          .startDate));
        this.tenorMappingForm.controls['endDate'].setValue(new Date(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex]
          .endDate));
        // tslint:disable-next-line:max-line-length
        this.tenorMappingForm.controls['ctrmStatus'].setValue(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex].ctrmStatus);
        this.tenorMappingForm.controls['erpStatus'].setValue(this.financialCalendarModel.tenorFinancialArray[this.ArrayIndex].erpStatus);
      }
    }
