...
public class ContractTermsPurchaseDto{

	//validations removed as it will be handled from UI
	private Integer contractTermsPurchaseId;
	...
	public Integer getContractTermsPurchaseId() {
		return contractTermsPurchaseId;
	}
	public void setContractTermsPurchaseId(Integer contractTermsPurchaseId) {
		this.contractTermsPurchaseId = contractTermsPurchaseId;
	}
