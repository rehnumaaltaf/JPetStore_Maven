 ...
 */
@Entity
@Table(name = "MASTER_CONTRACT_TERMS_PURCHASE")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MasterContractTermsPurchase.findAll", query = "SELECT m FROM MasterContractTermsPurchase m")})
public class MasterContractTermsPurchase implements Serializable {

    private static final long serialVersionUID = 1L;
    @SequenceGenerator(name="MASTER_CONTACT_TERMS_PURCHASE_CONTRACTTERMSPURCHASEIDSEQ_GENERATOR", sequenceName="CONTRACT_TERMS_PURCHASE_ID_SEQ",allocationSize=1)
	@GeneratedValue(generator="MASTER_CONTACT_TERMS_PURCHASE_CONTRACTTERMSPURCHASEIDSEQ_GENERATOR")
    @Id
    @Basic(optional = false)
    @NotNull
    @Column(name = "PK_CONTRACT_TERMS_PURCHASE_ID")
    private Integer pkContractTermsPurchaseId;
    ...
    public MasterContractTermsPurchase() {
    }

    public MasterContractTermsPurchase(Integer pkContractTermsPurchaseId) {
        this.pkContractTermsPurchaseId = pkContractTermsPurchaseId;
    }

    public Integer getPkContractTermsPurchaseId() {
        return pkContractTermsPurchaseId;
    }

    public void setPkContractTermsPurchaseId(Integer pkContractTermsPurchaseId) {
        this.pkContractTermsPurchaseId = pkContractTermsPurchaseId;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (pkContractTermsPurchaseId != null ? pkContractTermsPurchaseId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MasterContractTermsPurchase)) {
            return false;
        }
        MasterContractTermsPurchase other = (MasterContractTermsPurchase) object;
        if ((this.pkContractTermsPurchaseId == null && other.pkContractTermsPurchaseId != null) || (this.pkContractTermsPurchaseId != null && !this.pkContractTermsPurchaseId.equals(other.pkContractTermsPurchaseId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.olam.score.terms.domain.MasterContractTermsPurchase[ pkContractTermsPurchaseId=" + pkContractTermsPurchaseId + " ]";
    }
